...
const MZ: Record<number, ReturnType<typeof lot>[]> = {
  1: [
    lot('16.25x32',V), lot('15.5x32',V),  lot('15.5x32',V),  lot('15.5x32',F),
  ...
  2: [
    lot('16x32.5',V),   lot('15.5x32.5',V), lot('15.5x32.5',V), lot('15.5x32.5',V),
    lot('15x32.5',V),   lot('15.5x32.5',F), lot('15.5x32.5',F), lot('15.5x32.5',V),
    lot('16x32.5',V),   lot('16x30',V),     lot('12x30',V),     lot('12x30',R),
    lot('12x30',D),     lot('12x30',D),     lot('12x30',D),     lot('12x30',D),
  ...
  6: [
    lot('12x28',V),  lot('12x30',V),  lot('12x30',D),  lot('12x30',V),
    lot('12x30',V),  lot('12x30',V),  lot('12x30',V),  lot('12x30',V),
    ...
    lot('12x28',V),  lot('12x28',V),  lot('12x28',R),  lot('12x28',V),
  ],
  7: [
    ...
    lot('12x30',V),  lot('12x30',V),  lot('12x30',D),
    lot('12x26',V),  lot('12x26',D),  lot('12x26',V),  lot('12x26',V),
  ],
  8: [
    lot('15x30',D),  lot('12x30',D),  lot('12x30',D),  lot('12x30',D),
    lot('12x30',D),  lot('12x30',D),  lot('12x30',D),  lot('12x30',D),
    lot('12x26',V),  lot('12x26',V),  lot('12x26',V),  lot('12x26',V),
    lot('12x26',V),  lot('12x30',D),  lot('12x30',D),  lot('12x30',D),
    lot('12x30',D),  lot('12x30',D),  lot('12x30',D),  lot('12x30',D),
  ...
  9: [
    ...
    lot('12x28',V),  lot('12x30',D),  lot('12x30',D),  lot('12x30',D),
    lot('12x30',D),  lot('12x30',V),  lot('12x30',D),  lot('12x30',D),
    lot('12x28',V),  lot('12x28',V),  lot('12x28',V),  lot('12x28',D),
  ],
  10: [
    lot('12x26',V),  lot('12x30',D),  lot('12x30',NC), lot('12x30',NC),
    lot('12x30',NC), lot('12x30',NC), lot('12x30',V),  lot('12x30',V),
  ...
  11: [
    lot('15.55x30',V), lot('15.55x30',V), lot('15.55x30',V), lot('15.55x30',R),
    lot('15.55x30',R), lot('15.55x30',R), lot('15.55x30',D), lot('15.55x30',D),
    lot('15.55x30',F), lot('15.55x30',F), lot('15.55x30',F), lot('15.55x30',F),
    lot('15.55x30',D), lot('15.55x30',D), lot('15.55x30',D), lot('15.55x30',D),
    lot('15.55x30',D), lot('15.55x30',D),
  ],
  12: [
    lot('15x30',V),  lot('12x30',D),  lot('12x30',D),  lot('12x30',D),
    lot('12x30',D),  lot('12x30',D),  lot('12x30',D),  lot('12x30',D),
  ...
  13: [
    lot('12x28',D),  lot('12x30',D),  lot('12x30',D),  lot('12x30',D),
    lot('12x30',D),  lot('12x30',D),  lot('12x30',D),  lot('12x30',D),
    lot('12x28',V),  lot('12x28',D),  lot('12x28',V),  lot('12x28',V),
    lot('12x28',V),  lot('12x30',NC), lot('12x30',NC), lot('12x30',V),
    lot('12x30',D),  lot('12x30',D),  lot('12x30',D),  lot('12x30',D),
  ...
  14: [
    ...
    lot('15x30',V),  lot('15x30',R),  lot('15x30',D),  lot('15x30',V),
